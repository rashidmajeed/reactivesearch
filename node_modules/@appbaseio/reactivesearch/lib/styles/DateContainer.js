...
var DateContainer = /*#__PURE__*/(0, _reactEmotion2.default)('div', {
	...
	return (0, _utils.shade)(theme.colors.primaryColor, 0.1);
...
}, ';&:focus{background-color:', function (_ref10) {
	var colors = _ref10.theme.colors;
	return colors.backgroundColor || '#fff';
}, ';}}.DayPickerInput-OverlayWrapper{position:absolute;width:100%;left:0;z-index:4;}.DayPickerInput-Overlay{left:0;top:1px;z-index:1;position:absolute;background:', function (_ref11) {
	var colors = _ref11.theme.colors;
	return colors.backgroundColor ? (0, _utils.shade)(colors.backgroundColor, 0.15) : '#fff';
}, ';box-shadow:0 2px 5px rgba(0,0,0,0.15);}', function (_ref12) {
